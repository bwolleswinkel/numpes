...
class TestPolytopeRepr:
    ...
    @pytest.mark.parametrize('poly, expected_str', [
        (pes.poly([[1, 0],
                   [0, 1],
                   [0, 0]]),
         "Polytope(_vrepr=(NDArray[shape=(3, 2), dtype=int64], NDArray[shape=(0, 2), dtype=float64]), _hrepr=None, _is_empty=None, _is_degen=None, _is_bounded=None, _is_full_dim=None, _is_pointed=None, _is_singleton=None, _dim=None, _vol=None, _diam=None, _chebcr=None)"),
    ])
    ...
    @pytest.mark.parametrize('poly, expected_str', [
        ...
        (pes.poly([[-1,  0],
                   ...
                   [ 1,  0],
                   [ 0,  1]], [0, 0, 1.0, 1.0]),
         "Polytope(_vrepr=None, _hrepr=(NDArray[shape=(4, 3), dtype=float64], NDArray[shape=(0, 3), dtype=float64]), _is_empty=None, _is_degen=None, _is_bounded=None, _is_full_dim=None, _is_pointed=None, _is_singleton=None, _dim=None, _vol=None, _diam=None, _chebcr=None)"),
    ])
