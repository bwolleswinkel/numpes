...
class Axes1D(_AxesBase):
    ...
    def plot(self, *args, **kwargs):
        ...
        return super().plot(*args, **kwargs)  # pylint: disable=no-member
    ...
    def scatter(
        ...
        *, colorizer=None, plotnonfinite=False, **kwargs,
        ...
        if y is None:
            y = np.zeros_like(x)
        return super().scatter(  # pylint: disable=no-member
    ...
    def text(self, x, s, **kwargs):
        ...
        if 'ha' not in kwargs and 'ha' not in kwargs:
            kwargs['ha'] = 'center'
        return super().text(x, 0.04, s, **kwargs)  # pylint: disable=no-member
    ...
    def legend(self, *args, **kwargs):
        ...
        return super().legend(*args, **kwargs)  # pylint: disable=no-member
    ...
    def set_ylim(self, *args, **kwargs):
        ...
        if not self._updating_ylim:
            ...
            super().set_ylim(self.fixed_ylim)  # pylint: disable=no-member
        else:
            super().set_ylim(*args, **kwargs)  # pylint: disable=no-member
    ...
    def set_fixed_ylim(self, ylim):
        ...
        self._updating_ylim = True
        super().set_ylim(ylim)  # pylint: disable=no-member
        self._updating_ylim = False
